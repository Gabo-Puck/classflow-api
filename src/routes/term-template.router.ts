...
termTemplates.post("/create", asyncHandler(termController.create.bind(termController)));
termTemplates.put("/edit", asyncHandler(termController.update.bind(termController)));
