...
INSERT INTO "new_Assignment" ("autoGrade", "categoryId", "classId", "createdAt", "description", "dueAt", "formId", "groupId", "id", "latePenalty", "penaltyValue", "title", "updatedAt") SELECT "autoGrade", "categoryId", "classId", "createdAt", "description", "dueAt", "formId", "groupId", "id", "latePenalty", "penaltyValue", "title", "updatedAt" FROM "Assignment";
